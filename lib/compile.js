...
var translate = (function () {
  ...
  function set(node, options, resume, params) {
    visit(node.elts[0], options, function (err, val) {
      if (typeof val !== "object" || !val || !val.world) {
      ...
      visit(node.elts[1], options, function (err2, val2) {
        ...
        visit(node.elts[2], options, function (err3, val3) {
          ...
          http.get("http://bl.ocks.org/mbostock/raw/4090846/world-50m.json", function (res) {
            ...
            res.on('end', function () {
              ret.world = JSON.parse(pr);
              ret.mesh = topojson.mesh(ret.world, ret.world.objects.countries, function (a, b) {
                return a !== b;
              });
              ret.feature = topojson.feature(ret.world, ret.world.objects.land);
